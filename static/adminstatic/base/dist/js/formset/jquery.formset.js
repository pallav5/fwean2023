...
;(function($) {
    ...
    $.fn.formset.defaults = {
        ...
        addCssClass: ' text-white mt-2 btn btn-sm btn-success add-row  ',          // CSS class applied to the add link
        deleteCssClass: ' text-white btn btn-sm btn-danger delete-row',    // CSS class applied to the delete link
